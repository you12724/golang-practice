...
func TestEqual(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{1.01, 1, false},
		{1.0E-9, 1.0E-8, false},
		{1.0 + 1.0E-11, 1.0, true},
		// complex
		{complex(1, 0), complex(2, 0), false},
		{complex(1, 1), complex(1, 1), true},
		{complex(1, 1), complex(1, 2), false},
		{complex(1.0+1.0E-11, 1), complex(1.0, 1), true},
		{complex(1.0+1.0E-9, 1), complex(1.0, 1), false},
		{complex(1, 1.0+1.0E-11), complex(1, 1.0), true},
		{complex(1, 1.0), complex(1, 1.0+1.0E-8), false},
		{"foo", "foo", true},
		{"foo", "bar", false},
